...
forge test -f $FORK_BASE_NODE_URL --mc LiquidityManagerBase -vvv      # Base (Balancer -> Slipstream)
forge test -f $FORK_BASE_NODE_URL --mc LiquidityManagerBalancerUniV3Base -vvv  # Base fork of the Balancer -> UniV3 manager
