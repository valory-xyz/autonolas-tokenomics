...
async function main() {
    ...
    console.log("2. EOA to deploy UniswapPriceOracle");
    ...
    if (parsedData.contractVerification) {
        ...
        execSync("npx hardhat verify --constructor-args scripts/deployment/oracles/verify_02_uniswap_price_oracle.js --network " + providerName + " " + uniswapPriceOracle.address, { encoding: "utf-8" });
    }
}
