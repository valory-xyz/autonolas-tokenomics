...
async function main() {
    ...
    console.log("1. EOA to deploy BalancerPriceOracle");
    ...
    if (parsedData.contractVerification) {
        ...
        execSync("npx hardhat verify --constructor-args scripts/deployment/oracles/verify_01_balancer_price_oracle.js --network " + providerName + " " + balancerPriceOracle.address, { encoding: "utf-8" });
    }
}
