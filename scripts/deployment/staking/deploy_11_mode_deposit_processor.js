...
async function main() {
    ...
    console.log("11. EOA to deploy OptimismDepositProcessorL1 for Mode");
    ...
    console.log("Contract address:", modeDepositProcessorL1.address);
    ...
    parsedData.modeDepositProcessorL1Address = modeDepositProcessorL1.address;
    fs.writeFileSync(globalsFile, JSON.stringify(parsedData));

    // Contract verification
    if (parsedData.contractVerification) {
        const execSync = require("child_process").execSync;
        execSync("npx hardhat verify --constructor-args scripts/deployment/staking/verify_11_mode_deposit_processor.js --network " + providerName + " " + modeDepositProcessorL1.address, { encoding: "utf-8" });
    }
}
