...
const main = async () => {
    ...
    const l1DepositProcessorAddress = "0x7781202B9b09B92F512A0E343F24d349d09bc3A6";
    const l2TargetDispenserAddress = "0xaC26774616bbeD41b0CB69EA2ae7de366F430b23";
    ...
    const finalPayload = ethers.utils.defaultAbiCoder.encode(["address", "uint256", "uint256", "uint256", "uint256"],
        [EOAarbitrumSepolia.address, gasPriceBid, gasLimitMessage, maxSubmissionCostMessage, maxSubmissionCostToken]);
    ...
    const tx = await dispenser.connect(EOAsepolia).mintAndSend(targetInstance, defaultAmount, l1DepositProcessorAddress,
        finalPayload, {value: totalCost, gasLimit });
