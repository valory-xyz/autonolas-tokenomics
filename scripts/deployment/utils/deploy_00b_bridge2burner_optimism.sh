...
l2StandardBridgeProxyAddress=$(jq -r '.l2StandardBridgeProxyAddress' $globals)

contractName="Bridge2BurnerOptimism"
contractPath="contracts/utils/$contractName.sol:$contractName"
constructorArgs="$olasAddress $l2StandardBridgeProxyAddress"
