...
#
#
##oracleV2Address="0xeDd71796B90eaCc56B074C39BAC90ED2Ca6D93Ee"
#contractName="LiquidityManagerETH"
#contractPath="contracts/pol/$contractName.sol:$contractName"
#constructorArgs="$olasAddress $timelockAddress $oracleV2Address $routerV2Address $positionManagerV3 $observationCardinality $maxSlippage"
#contractArgs="$contractPath --constructor-args $constructorArgs"
#
#
## Deployment message
...
## Verify contract
#if [ "$contractVerification" == "true" ]; then
#  contractParams="$liquidityManagerETHAddress $contractPath --constructor-args $(cast abi-encode "constructor(address,address,address,address,address,uint16,uint16)" $constructorArgs)"
#  echo "Verification contract params: $contractParams"
#
#  TENDERLY_VERIFIER_URL="$TENDERLY_VIRTUAL_TESTNET_RPC/verify/etherscan"
#  echo "${green}Verifying contract on Etherscan...${reset}"
